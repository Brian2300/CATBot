...
'''This method insert chat_id, veri_code and temp_smu_email_address into db'''
def first_insert_prof(chat_id, veri_code, temp_id):
    connection = pymysql.connect(host = hostname,
                                user= username,
                                password=password,
                                db=database)
    ...
    try:
        with connection.cursor() as cursor:
            # Create a new record
            sql = "INSERT INTO `professor_tele` ( `chat_id`,  `veri_code`,`temp_smu_email_address`) VALUES ( %s, %s, %s)"
            cursor.execute(sql, (chat_id, veri_code, temp_id))
...
'''This method retrieves the stored values of the "chat_id" and "veri_code". '''
def retrieve_first_insert_prof(chat_id):
    connection = pymysql.connect(host = hostname,
                                user= username,
                                password=password,
                                db=database)
    ...
    try:
        with connection.cursor() as cursor:
            sql = "SELECT `veri_code` FROM `professor_tele` WHERE `chat_id` = %s"
            cursor.execute(sql, (chat_id))
            result = cursor.fetchone()
...
"""This method inserts verified smu_email into database"""
def insert_smu_email_prof(chat_id):
    connection = pymysql.connect(host = hostname,
                                user= username,
                                password=password,
                                db=database)
    ...
    try:
        # retrieve temp_smu_email_address
        with connection.cursor() as cursor:
            sql = "SELECT `temp_smu_email_address` FROM `professor_tele` WHERE `chat_id` = %s"
            cursor.execute(sql, (chat_id))
            result = cursor.fetchone()
        
        # insert temp into primary key.
        with connection.cursor() as cursor:
            sql = "UPDATE `professor_tele` SET `smu_email` = %s WHERE `chat_id` = %s"
            cursor.execute(sql, (result[0],chat_id))       
...
"""This method retrieves the number of rows that a particular temp_smu_email_address appears in database.(COUNT)"""   
def check_smu_email_address_existance_prof(temp_smu_email_address): 
    connection = pymysql.connect(host = hostname,
                            user= username,
                            password=password,
                            db=database)  
    ...
    try:
        with connection.cursor() as cursor:
            sql = "SELECT COUNT(*) FROM `professor_tele` WHERE `temp_smu_email_address` = %s"
            cursor.execute(sql, (temp_smu_email_address))
            result = cursor.fetchone()
...
"""This method retrieves the number of rows of a particular chat_id"""
def retrieve_num_chat_id_prof(chat_id):
    connection = pymysql.connect(host = hostname,
                                user= username,
                                password=password,
                                db=database)
...
"""This method deletes the wrong smu email entry line by using chat_id"""
def delete_duplicate_chat_id_prof(chat_id):       
    connection = pymysql.connect(host = hostname,
                                user= username,
                                password=password,
                                db=database)
    ...
    try:
        with connection.cursor() as cursor:
            sql = "DELETE FROM `professor_tele` WHERE `chat_id` = %s"
            cursor.execute(sql, (chat_id))
