...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000007037be680000000003ce9a1c(
...
class phpbbtemplatetwiglexer_000000007037be680000000003ce9a1c extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5993d36189d4b332044931 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5993d36189d57523321778 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5993d36189d23727962455 = array(
    ...
    {
        $this->initializer5993d36189d57523321778 && $this->initializer5993d36189d57523321778->__invoke($this->valueHolder5993d36189d4b332044931, $this, 'set_environment', array('env' => $env), $this->initializer5993d36189d57523321778);

        return $this->valueHolder5993d36189d4b332044931->set_environment($env);
    }
    ...
    {
        $this->initializer5993d36189d57523321778 && $this->initializer5993d36189d57523321778->__invoke($this->valueHolder5993d36189d4b332044931, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5993d36189d57523321778);

        return $this->valueHolder5993d36189d4b332044931->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5993d36189d57523321778 && $this->initializer5993d36189d57523321778->__invoke($this->valueHolder5993d36189d4b332044931, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5993d36189d57523321778);

        return $this->valueHolder5993d36189d4b332044931->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5993d36189d57523321778 = $initializer;
    }
    ...
    {
        $this->initializer5993d36189d57523321778 && $this->initializer5993d36189d57523321778->__invoke($this->valueHolder5993d36189d4b332044931, $this, '__get', array('name' => $name), $this->initializer5993d36189d57523321778);

        if (isset(self::$publicProperties5993d36189d23727962455[$name])) {
            return $this->valueHolder5993d36189d4b332044931->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5993d36189d4b332044931;
    ...
    {
        $this->initializer5993d36189d57523321778 && $this->initializer5993d36189d57523321778->__invoke($this->valueHolder5993d36189d4b332044931, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5993d36189d57523321778);
    ...
    {
        $this->initializer5993d36189d57523321778 && $this->initializer5993d36189d57523321778->__invoke($this->valueHolder5993d36189d4b332044931, $this, '__isset', array('name' => $name), $this->initializer5993d36189d57523321778);
    ...
    {
        $this->initializer5993d36189d57523321778 && $this->initializer5993d36189d57523321778->__invoke($this->valueHolder5993d36189d4b332044931, $this, '__unset', array('name' => $name), $this->initializer5993d36189d57523321778);
    ...
    {
        $this->initializer5993d36189d57523321778 && $this->initializer5993d36189d57523321778->__invoke($this->valueHolder5993d36189d4b332044931, $this, '__clone', array(), $this->initializer5993d36189d57523321778);

        $this->valueHolder5993d36189d4b332044931 = clone $this->valueHolder5993d36189d4b332044931;
    }

    public function __sleep()
    {
        $this->initializer5993d36189d57523321778 && $this->initializer5993d36189d57523321778->__invoke($this->valueHolder5993d36189d4b332044931, $this, '__sleep', array(), $this->initializer5993d36189d57523321778);

        return array('valueHolder5993d36189d4b332044931');
    }
    ...
    {
        return $this->initializer5993d36189d57523321778;
    }
    ...
    {
        return $this->initializer5993d36189d57523321778 && $this->initializer5993d36189d57523321778->__invoke($this->valueHolder5993d36189d4b332044931, $this, 'initializeProxy', array(), $this->initializer5993d36189d57523321778);
    }
    ...
    {
        return null !== $this->valueHolder5993d36189d4b332044931;
    }
    ...
    {
        return $this->valueHolder5993d36189d4b332044931;
    }
