...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'kasimi.logoutredirect.listener' => 'getKasimi_Logoutredirect_ListenerService',
            ...
            'robertheim.topictags.acp.manage_tags_controller' => 'getRobertheim_Topictags_Acp_ManageTagsControllerService',
            'robertheim.topictags.acp.white_and_blacklist_controller' => 'getRobertheim_Topictags_Acp_WhiteAndBlacklistControllerService',
            'robertheim.topictags.acp_listener' => 'getRobertheim_Topictags_AcpListenerService',
            'robertheim.topictags.controller' => 'getRobertheim_Topictags_ControllerService',
            'robertheim.topictags.db_helper' => 'getRobertheim_Topictags_DbHelperService',
            'robertheim.topictags.listener' => 'getRobertheim_Topictags_ListenerService',
            'robertheim.topictags.tagcloud_manager' => 'getRobertheim_Topictags_TagcloudManagerService',
            'robertheim.topictags.tags_manager' => 'getRobertheim_Topictags_TagsManagerService',
    ...
    protected function getDispatcherService()
    {
        ...
        $instance->addSubscriberService('kasimi.logoutredirect.listener', 'kasimi\\logoutredirect\\event\\listener');
        ...
        $instance->addSubscriberService('robertheim.topictags.listener', 'robertheim\\topictags\\event\\main_listener');
        $instance->addSubscriberService('robertheim.topictags.acp_listener', 'robertheim\\topictags\\event\\acp_listener');
    ...
    /**
     * Gets the 'kasimi.logoutredirect.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \kasimi\logoutredirect\event\listener A kasimi\logoutredirect\event\listener instance
     */
    protected function getKasimi_Logoutredirect_ListenerService()
    {
        return $this->services['kasimi.logoutredirect.listener'] = new \kasimi\logoutredirect\event\listener($this->get('config'));
    }
    ...
    /**
     * Gets the 'robertheim.topictags.acp.manage_tags_controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \robertheim\topictags\acp\manage_tags_controller A robertheim\topictags\acp\manage_tags_controller instance
     */
    protected function getRobertheim_Topictags_Acp_ManageTagsControllerService()
    {
        return $this->services['robertheim.topictags.acp.manage_tags_controller'] = new \robertheim\topictags\acp\manage_tags_controller($this->get('config'), $this->get('request'), $this->get('user'), $this->get('template'), $this->get('pagination'), $this->get('robertheim.topictags.tags_manager'));
    }

    /**
     * Gets the 'robertheim.topictags.acp.white_and_blacklist_controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \robertheim\topictags\acp\white_and_blacklist_controller A robertheim\topictags\acp\white_and_blacklist_controller instance
     */
    protected function getRobertheim_Topictags_Acp_WhiteAndBlacklistControllerService()
    {
        return $this->services['robertheim.topictags.acp.white_and_blacklist_controller'] = new \robertheim\topictags\acp\white_and_blacklist_controller($this->get('config'), $this->get('config_text'), $this->get('request'), $this->get('user'), $this->get('template'), $this->get('robertheim.topictags.tags_manager'));
    }

    /**
     * Gets the 'robertheim.topictags.acp_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \robertheim\topictags\event\acp_listener A robertheim\topictags\event\acp_listener instance
     */
    protected function getRobertheim_Topictags_AcpListenerService()
    {
        return $this->services['robertheim.topictags.acp_listener'] = new \robertheim\topictags\event\acp_listener($this->get('request'), $this->get('user'), $this->get('robertheim.topictags.tags_manager'));
    }

    /**
     * Gets the 'robertheim.topictags.controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \robertheim\topictags\controller\main A robertheim\topictags\controller\main instance
     */
    protected function getRobertheim_Topictags_ControllerService()
    {
        return $this->services['robertheim.topictags.controller'] = new \robertheim\topictags\controller\main($this->get('config'), $this->get('template'), $this->get('controller.helper'), $this->get('request'), $this->get('user'), $this->get('auth'), $this->get('dispatcher'), $this->get('pagination'), $this->get('content.visibility'), 'php', './../', $this->get('robertheim.topictags.tags_manager'), $this->get('robertheim.topictags.tagcloud_manager'));
    }

    /**
     * Gets the 'robertheim.topictags.db_helper' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \robertheim\topictags\service\db_helper A robertheim\topictags\service\db_helper instance
     */
    protected function getRobertheim_Topictags_DbHelperService()
    {
        return $this->services['robertheim.topictags.db_helper'] = new \robertheim\topictags\service\db_helper($this->get('dbal.conn.driver'));
    }

    /**
     * Gets the 'robertheim.topictags.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \robertheim\topictags\event\main_listener A robertheim\topictags\event\main_listener instance
     */
    protected function getRobertheim_Topictags_ListenerService()
    {
        return $this->services['robertheim.topictags.listener'] = new \robertheim\topictags\event\main_listener($this->get('config'), $this->get('robertheim.topictags.tags_manager'), $this->get('controller.helper'), $this->get('request'), $this->get('user'), $this->get('template'), $this->get('auth'), $this->get('robertheim.topictags.tagcloud_manager'));
    }

    /**
     * Gets the 'robertheim.topictags.tagcloud_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \robertheim\topictags\service\tagcloud_manager A robertheim\topictags\service\tagcloud_manager instance
     */
    protected function getRobertheim_Topictags_TagcloudManagerService()
    {
        return $this->services['robertheim.topictags.tagcloud_manager'] = new \robertheim\topictags\service\tagcloud_manager($this->get('dbal.conn.driver'), $this->get('config'), $this->get('template'), $this->get('user'), $this->get('controller.helper'), 'phpbb_');
    }

    /**
     * Gets the 'robertheim.topictags.tags_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \robertheim\topictags\service\tags_manager A robertheim\topictags\service\tags_manager instance
     */
    protected function getRobertheim_Topictags_TagsManagerService()
    {
        return $this->services['robertheim.topictags.tags_manager'] = new \robertheim\topictags\service\tags_manager($this->get('dbal.conn.driver'), $this->get('config'), $this->get('config_text'), $this->get('auth'), $this->get('robertheim.topictags.db_helper'), 'phpbb_');
    }
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000027ac08c00000000665e25d1(
...
class phpbbtemplatetwiglexer_00000000027ac08c00000000665e25d1 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5993d2d78d162344581622 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5993d2d78d16e078202941 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5993d2d78d138600173263 = array(
    ...
    {
        $this->initializer5993d2d78d16e078202941 && $this->initializer5993d2d78d16e078202941->__invoke($this->valueHolder5993d2d78d162344581622, $this, 'set_environment', array('env' => $env), $this->initializer5993d2d78d16e078202941);

        return $this->valueHolder5993d2d78d162344581622->set_environment($env);
    }
    ...
    {
        $this->initializer5993d2d78d16e078202941 && $this->initializer5993d2d78d16e078202941->__invoke($this->valueHolder5993d2d78d162344581622, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5993d2d78d16e078202941);

        return $this->valueHolder5993d2d78d162344581622->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5993d2d78d16e078202941 && $this->initializer5993d2d78d16e078202941->__invoke($this->valueHolder5993d2d78d162344581622, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5993d2d78d16e078202941);

        return $this->valueHolder5993d2d78d162344581622->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5993d2d78d16e078202941 = $initializer;
    }
    ...
    {
        $this->initializer5993d2d78d16e078202941 && $this->initializer5993d2d78d16e078202941->__invoke($this->valueHolder5993d2d78d162344581622, $this, '__get', array('name' => $name), $this->initializer5993d2d78d16e078202941);

        if (isset(self::$publicProperties5993d2d78d138600173263[$name])) {
            return $this->valueHolder5993d2d78d162344581622->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5993d2d78d162344581622;
    ...
    {
        $this->initializer5993d2d78d16e078202941 && $this->initializer5993d2d78d16e078202941->__invoke($this->valueHolder5993d2d78d162344581622, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5993d2d78d16e078202941);
    ...
    {
        $this->initializer5993d2d78d16e078202941 && $this->initializer5993d2d78d16e078202941->__invoke($this->valueHolder5993d2d78d162344581622, $this, '__isset', array('name' => $name), $this->initializer5993d2d78d16e078202941);
    ...
    {
        $this->initializer5993d2d78d16e078202941 && $this->initializer5993d2d78d16e078202941->__invoke($this->valueHolder5993d2d78d162344581622, $this, '__unset', array('name' => $name), $this->initializer5993d2d78d16e078202941);
    ...
    {
        $this->initializer5993d2d78d16e078202941 && $this->initializer5993d2d78d16e078202941->__invoke($this->valueHolder5993d2d78d162344581622, $this, '__clone', array(), $this->initializer5993d2d78d16e078202941);

        $this->valueHolder5993d2d78d162344581622 = clone $this->valueHolder5993d2d78d162344581622;
    }

    public function __sleep()
    {
        $this->initializer5993d2d78d16e078202941 && $this->initializer5993d2d78d16e078202941->__invoke($this->valueHolder5993d2d78d162344581622, $this, '__sleep', array(), $this->initializer5993d2d78d16e078202941);

        return array('valueHolder5993d2d78d162344581622');
    }
    ...
    {
        return $this->initializer5993d2d78d16e078202941;
    }
    ...
    {
        return $this->initializer5993d2d78d16e078202941 && $this->initializer5993d2d78d16e078202941->__invoke($this->valueHolder5993d2d78d162344581622, $this, 'initializeProxy', array(), $this->initializer5993d2d78d16e078202941);
    }
    ...
    {
        return null !== $this->valueHolder5993d2d78d162344581622;
    }
    ...
    {
        return $this->valueHolder5993d2d78d162344581622;
    }
