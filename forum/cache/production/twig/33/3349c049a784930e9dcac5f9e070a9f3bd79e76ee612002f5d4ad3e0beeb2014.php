...
/* index_body.html */
class __TwigTemplate_5a97374acaf213906d7c227f7a0f19a0398a2fdcfc2ea405bc2bb9188c2fa2cf extends Twig_Template
{
...
\t\t\t\t\t\t";
            // line 78
            // line 79
            echo "\t\t\t\t\t\t<!-- remove Total members and newest users -->
\t\t\t\t\t\t";
            // line 80
...
\t\t\t\t\t\t";
            ...
            $this->env->loadTemplate('@robertheim_topictags/event/index_body_block_stats_append.html')->display($context);
            $this->env->setNamespaceLookUpOrder($previous_look_up_order);
            // line 82
            echo "\t\t\t\t\t</p>
\t\t\t\t</div>
...
";
        ...
        $this->loadTemplate("overall_footer.html", "index_body.html", 93)->display($context);
        if ($namespace) {
            $this->env->setNamespaceLookUpOrder($previous_look_up_order);
        }
    }
...
/* 						<!-- remove Total members and newest users -->*/
