...
/* forumlist_body.html */
class __TwigTemplate_b9425a59f8f304a69fb6f9ca583739b5d9422fee4cfa06f77c0101d03de19f8f extends Twig_Template
{
...
\t\t\t\t\t\t\t";
                    ...
                    if ($this->getAttribute($context["forumrow"], "LAST_POST_TIME", array())) {
                        ...
                        echo $this->env->getExtension('phpbb')->lang("LAST_POST");
                        echo "</dfn>
\t\t\t\t\t\t\t\t<!-- remove, last post title, by author, line 92 - 101-->
\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t<br />";
                        // line 94
