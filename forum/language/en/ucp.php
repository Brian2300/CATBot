...
$lang = array_merge($lang, array(
	...
	<br />
	You agree not to post any abusive, obscene, vulgar, slanderous, hateful, threatening, sexually-orientated or any other material that may violate any laws be it of your country, the country where “%1$s” is hosted or International Law. Doing so may lead to you being immediately and permanently banned, with notification of your Internet Service Provider if deemed required by us. The IP address of all posts are recorded to aid in enforcing these conditions. You agree that “%1$s” have the right to remove, edit, move or close any question at any time should we see fit. As a user you agree to any information you have entered to being stored in a database. While this information will not be disclosed to any third party without your consent, neither “%1$s” nor phpBB shall be held responsible for any hacking attempt that may lead to the data being compromised.
	',
...
$lang = array_merge($lang, array(
	...
	'BOOKMARKS'					=> 'Bookmarks',
	'BOOKMARKS_EXPLAIN'			=> 'You can bookmark questions for future reference. Select the checkbox for any bookmark you wish to delete, then press the <em>Remove marked bookmarks</em> button.',
	...
	'NOTIFICATION_TYPE_BOOKMARK'						=> 'Someone replies to a question you have bookmarked',
	'NOTIFICATION_TYPE_GROUP_REQUEST'					=> 'Someone requests to join a group you lead',
	'NOTIFICATION_TYPE_IN_MODERATION_QUEUE'				=> 'A post or question needs approval',
	'NOTIFICATION_TYPE_MODERATION_QUEUE'				=> 'Your questions/posts are approved or disapproved by a moderator',
	'NOTIFICATION_TYPE_PM'								=> 'Someone sends you a private message',
	'NOTIFICATION_TYPE_POST'							=> 'Someone replies to a question to which you are subscribed',
	'NOTIFICATION_TYPE_QUOTE'							=> 'Someone quotes you in a post',
	'NOTIFICATION_TYPE_REPORT'							=> 'Someone reports a post',
	'NOTIFICATION_TYPE_TOPIC'							=> 'Someone creates a question in a forum to which you are subscribed',
	...
	'NO_WATCHED_SELECTED'		=> 'You have not selected any subscribed questions or forums.',
	'NO_WATCHED_TOPICS'			=> 'You are not subscribed to any questions.',
	...
	'UCP_WELCOME'					=> 'Welcome to the User Control Panel. From here you can monitor, view and update your profile, preferences, subscribed forums and questions. You can also send messages to other users (if permitted). Please ensure you read any announcements before continuing.',
	...
	'VIEW_TOPICS_DAYS'			=> 'Display questions from previous days',
	'VIEW_TOPICS_DIR'			=> 'Display question order direction',
	'VIEW_TOPICS_KEY'			=> 'Display questions ordering by',
	...
	'WATCHED_EXPLAIN'			=> 'Below is a list of forums and questions you are subscribed to. You will be notified of new posts in either. To unsubscribe mark the forum or question and then press the <em>Unwatch marked</em> button.',
	'WATCHED_FORUMS'			=> 'Watched forums',
	'WATCHED_TOPICS'			=> 'Watched questions',
